...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" href="/images/Libraria.png?v=2">
        <link rel="shortcut icon" href="/images/Libraria.png?v=2">
        <link rel="apple-touch-icon" href="/images/Libraria.png?v=2">
